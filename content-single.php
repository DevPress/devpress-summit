	...
	<?php if ( get_the_author_meta( 'description' ) ) : ?>
		<div class="author-meta clearfix">
			<div class="author-avatar">
				<?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'currents_author_bio_avatar_size', 60 ) ); ?>
			</div>
			<div class="author-description">
				<h3><?php printf( esc_attr__( 'About %s', 'currents' ), get_the_author() ); ?></h3>
